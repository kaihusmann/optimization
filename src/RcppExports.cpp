...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(var_funcc(para_0, fun_length, rf));
    return __result;
END_RCPP
}
// main_loop
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(main_loop(temp, t_min, r, fun_length, nlimit, para_0, para_i, var_func, vf_user, rf, lower, upper, fun, loss_0, k, loss_opt, para_opt, dyn_rf, maxgood, ac_acc, stopac));
    return __result;
END_RCPP
}
